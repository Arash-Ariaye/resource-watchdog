...
## 📄 توضیح
 ...
 اسکریپت **Resource Watchdog** برای سرورهای لینوکس است که به صورت خودکار مصرف **CPU** و **RAM** را مانیتور می‌کند و در صورت رسیدن مصرف به حد بالا، سرویس‌های اصلی تانل‌های **Backhaul، Hotfix و Packet** را ری‌استارت می‌کند.
